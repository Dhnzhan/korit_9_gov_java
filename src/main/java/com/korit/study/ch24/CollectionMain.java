...
public class CollectionMain {
    public static void main(String[] args) {
        ...
        int index0f30 = list.indexOf("30"); // 앞에서 부터 찾음
        System.out.println(index0f30);

        // 중간에 위피하고 있는 데이터 30의 index를 찾는 방법
        ...
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).equals("30")) {
                index0f30 = i;
                break;
                // break 걸면 앞에서 부터 걸지 않으면 뒤에서 부터
            }
        }
        System.out.println(index0f30);

        index0f30 = list.lastIndexOf("30"); // 뒤에서 부터 찾음
        System.out.println(index0f30);
...
//        }
        ...
        strMap.put("b", "김준이");
        strMap.put("c", "김준삼");
        strMap.put("d", "김준오"); //키 값 중복 x
        strMap.put("d", "김준사"); //덮어씀 (수정)
